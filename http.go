...
// GetRandUserAgent 随机获取一个UserAgent字符串
func GetRandUserAgent() string {
	return userAgents[rand.Intn(len(userAgents))]
}

// TrimHTTPRspBom 去除HTTP返回包里的BOM头
func TrimHTTPRspBom(s []byte) []byte {
	return bytes.TrimPrefix(s, []byte{0xEF, 0xBB, 0xBF})
}
...
var userAgents = []string{
	...
	"Mozilla/5.0 (iPhone; CPU iPhone OS 13_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 SP-engine/2.18.0 main%2F1.0 baiduboxapp/11.22.5.12 (Baidu; P2 13.4.1) NABar/1.0",
	...
	"Mozilla/5.0 (iPhone; CPU OS 13_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/25.0 Mobile/15E148 Safari/605.1.15",
	"Mozilla/5.0 (Linux; Android 5.0) AppleWebKit/537.36 (KHTML, like Gecko) Mobile Safari/537.36 (compatible; Bytespider; https://zhanzhang.toutiao.com/)",
	"Mozilla/5.0 (Linux; Android 9; MHA-AL00 Build/HUAWEIMHA-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/045104 Mobile Safari/537.36 V1_AND_SQ_7.1.0_0_TIM_D TIM/3.0.0.2860 QQ/6.5.5 NetType/4G WebP/0.3.0 Pixel/1080",
